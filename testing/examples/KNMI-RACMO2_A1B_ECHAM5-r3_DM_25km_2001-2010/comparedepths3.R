...
depths <- c(2, 10, 40)
fnameaffixes <- c('shallow', 'medium_d', 'deep')
depthnames <- paste(fnameaffixes, 'depth :', depths, 'm')
...
legend('topleft', legend = depthnames, lty = 1, col = colours) 
dev.off()
